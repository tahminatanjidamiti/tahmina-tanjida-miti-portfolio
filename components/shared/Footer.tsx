        ...
        <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="flex justify-start items-center gap-6 text-sm mt-2">
              <Link href="https://www.linkedin.com/in/tahminatanjida" target="_blank" className="p-2 rounded-full bg-yellow-600 hover:bg-yellow-700 border-2 border-amber-500 transition">
              ...
              <Link href="https://github.com/tahminatanjidamiti" target="_blank" className="p-2 rounded-full bg-yellow-600 hover:bg-yellow-700 border-2 border-amber-500 transition">
