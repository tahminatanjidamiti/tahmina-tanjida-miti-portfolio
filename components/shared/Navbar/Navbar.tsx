            ...
            >
              <div className="flex flex-col items-center mt-10 text-center space-y-4 overflow-y-auto pb-4">
                ...
                <div className="flex space-x-4 pt-4">
                  <Link href="https://www.linkedin.com/in/tahminatanjida" target="_blank" className="p-2 rounded-full bg-yellow-600 border-2 border-amber-500 hover:bg-yellow-700 transition">
                  ...
                  <Link href="https://github.com/tahminatanjidamiti" target="_blank" className="p-2 rounded-full bg-yellow-600 border-2 border-amber-500 hover:bg-yellow-700 transition">
